...
public class Activity6 extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
  @Override
  ...
  public boolean onDrag(View v, DragEvent event) {
    ...
    switch (action) {
      ...
      case DragEvent.ACTION_DRAG_ENTERED:
        ...
        v.getBackground().setColorFilter(new PorterDuffColorFilter(Color.GRAY, PorterDuff.Mode.SRC_IN));
